...
import LineSakachi
from LineSakachi.lib.curve.ttypes import *
...
admin=["c57197edb2d2b0b403e0f96b8f46b6a7a"]
wait = {
    'contact':True,
    'autoJoin':True,
...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            if msg.contentType == 13:
               if wait["wblack"] == True:
            ...
            elif msg.text in ["Sakachi cancel","Bot cancel"]:
                if msg.toType == 2:
                ...
                if msg.toType == 2:
                    ...
                    ki.updateGroup(X)
                    if wait["lang"] == "JP":
                        ki.sendText(msg.to,"Done Sakachi")
                    else:
                ...
                if msg.toType == 2:
                    ...
                    kk.updateGroup(X)
                    if wait["lang"] == "JP":
                        kk.sendText(msg.to,"Done Sakachi")
                    else:
                ...
                if msg.toType == 2:
                    ...
                    kc.updateGroup(X)
                    if wait["lang"] == "JP":
                        kc.sendText(msg.to,"Done Sakachi")
                    else:
